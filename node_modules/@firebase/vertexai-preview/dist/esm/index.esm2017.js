...
<<<<<<< HEAD
<<<<<<< HEAD
import { ErrorFactory, getModularInstance } from '@firebase/util';
...
<<<<<<< HEAD
const ERRORS = {
    ["fetch-error" /* VertexError.FETCH_ERROR */]: `Error fetching from {$url}: {$message}`,
    ["invalid-content" /* VertexError.INVALID_CONTENT */]: `Content formatting error: {$message}`,
    ["no-api-key" /* VertexError.NO_API_KEY */]: `The "apiKey" field is empty in the local Firebase config. Firebase VertexAI requires this field to` +
        `contain a valid API key.`,
    ["no-project-id" /* VertexError.NO_PROJECT_ID */]: `The "projectId" field is empty in the local Firebase config. Firebase VertexAI requires this field to` +
        `contain a valid project ID.`,
    ["no-model" /* VertexError.NO_MODEL */]: `Must provide a model name. ` +
        `Example: getGenerativeModel({ model: 'my-model-name' })`,
    ["parse-failed" /* VertexError.PARSE_FAILED */]: `Parsing failed: {$message}`,
    ["response-error" /* VertexError.RESPONSE_ERROR */]: `Response error: {$message}. Response body stored in ` +
        `error.customData.response`
};
const ERROR_FACTORY = new ErrorFactory('vertexAI', 'VertexAI', ERRORS);
=======
=======
>>>>>>> 0f587f7 (started working on development for leaderboard.js, html and edited css to customise leaderboard.html to match figma)
=======
...
<<<<<<< HEAD
        ...
        const e = caughtError;
        const err = ERROR_FACTORY.create("fetch-error" /* VertexError.FETCH_ERROR */, {
            url: url.toString(),
            message: e.message
        });
        err.stack = e.stack;
...
<<<<<<< HEAD
<<<<<<< HEAD
                throw ERROR_FACTORY.create("response-error" /* VertexError.RESPONSE_ERROR */, {
...
<<<<<<< HEAD
            throw ERROR_FACTORY.create("response-error" /* VertexError.RESPONSE_ERROR */, {
                message: `Function call not available. ${formatBlockErrorMessage(response)}`,
=======
...
<<<<<<< HEAD
<<<<<<< HEAD
                            controller.error(ERROR_FACTORY.create("parse-failed" /* VertexError.PARSE_FAILED */, {
...
<<<<<<< HEAD
<<<<<<< HEAD
        throw ERROR_FACTORY.create("invalid-content" /* VertexError.INVALID_CONTENT */, {
            message: 'Within a single message, FunctionResponse cannot be mixed with other type of part in the request for sending chat message.'
        });
    }
    if (!hasUserContent && !hasFunctionContent) {
        throw ERROR_FACTORY.create("invalid-content" /* VertexError.INVALID_CONTENT */, {
...
<<<<<<< HEAD
        ...
        if (!POSSIBLE_ROLES.includes(role)) {
            throw ERROR_FACTORY.create("invalid-content" /* VertexError.INVALID_CONTENT */, {
                message: `Each item should include role field. Got ${role} but valid roles are: ${JSON.stringify(POSSIBLE_ROLES)}`
            });
        }
...
<<<<<<< HEAD
                throw ERROR_FACTORY.create("invalid-content" /* VertexError.INVALID_CONTENT */, {
                    message: `Content with role '${role}' can't follow '${prevContent.role}'. Valid previous roles: ${JSON.stringify(VALID_PREVIOUS_CONTENT_ROLES)}`
                });
=======
...
<<<<<<< HEAD
<<<<<<< HEAD
            throw ERROR_FACTORY.create("no-api-key" /* VertexError.NO_API_KEY */);
        }
        else if (!((_d = (_c = vertexAI.app) === null || _c === void 0 ? void 0 : _c.options) === null || _d === void 0 ? void 0 : _d.projectId)) {
            throw ERROR_FACTORY.create("no-project-id" /* VertexError.NO_PROJECT_ID */);
=======
=======
>>>>>>> 0f587f7 (started working on development for leaderboard.js, html and edited css to customise leaderboard.html to match figma)
=======
...
<<<<<<< HEAD
<<<<<<< HEAD
        throw ERROR_FACTORY.create("no-model" /* VertexError.NO_MODEL */);
=======
...
<<<<<<< HEAD
<<<<<<< HEAD
export { BlockReason, ChatSession, FinishReason, FunctionCallingMode, FunctionDeclarationSchemaType, GenerativeModel, HarmBlockMethod, HarmBlockThreshold, HarmCategory, HarmProbability, HarmSeverity, POSSIBLE_ROLES, getGenerativeModel, getVertexAI };
=======
